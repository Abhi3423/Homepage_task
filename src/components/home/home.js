    ...
    return (
        <div>
            ...
            {/* <div className='box6 w-full flex flex-col mt-12' style={{ "height": "200vh" }}>
                ...
                <div className='self-center w-3/5 grid grid-cols-3 gap-1 mt-24'>
                    <div className='box1 flex flex-col'>
                        <div className='flex flex-row'>
                            <div className='w-12 h-12 rounded-full bg-gray-700'></div>
                            <span>Jawed Afroz</span>
                            <br></br>
                            <span>Associate Software Engineer at Mobileum</span>
                        </div>
                        <p>Hello Connections!<br></br><br></br>I am thrilled to announce that I've started my professional journey with Mobileum as Associate Software Engineer.<br></br>I would like to thank my family and friends for their constant support and also the entire team of Newton School for providing this amazing opportunity to kickstart my career.<br></br>Looking forward to a great learning experience!</p>
                    </div>
