...
export default function Navbar() {
  ...
  const handleMouseOver = () => {
    document.getElementById("beforehover").style.display = "none";
    document.getElementById("afterhover").style.display = "flex";
    setIsHovering(true);
  };

  const handleMouseOut = () => {
    setIsHovering(false);
    document.getElementById("beforehover").style.display = "flex";
  ...
  return (
    <>
      <div className='nbox'>
        <div className='navbar top-0 p-5 flex flex-row gap-8 items-center bg-black'>
          ...
          <img  id="beforehover" onClick={handleMouseOver} className='w-8 -ml-4 cursor-pointer' src={down} alt=''/>
          <img  id="afterhover" onClick={handleMouseOut} className='w-8 -ml-4 cursor-pointer hidden' src={down} alt=''/>
