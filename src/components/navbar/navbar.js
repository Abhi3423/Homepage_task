    ...
    <>
      <div className='box'>
        <div className='navbar sticky top-0 p-5 flex flex-row gap-8 items-center bg-black'>
          ...
          <button data-collapse-toggle="navbar-dropdown" type="button" class="inline-flex ml-32 md:ml-0 md:float-none p-2 text-sm text-gray-400 rounded-lg lg:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600" aria-controls="navbar-dropdown" aria-expanded="false">
